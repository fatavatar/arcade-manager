#pragma parameter height "CocktailTable Image Height" 0.99 -3.0 3.0 0.01
#pragma parameter width "CocktailTable Image Width" 1.99 -5.0 5.0 0.05
...
if ( fragCoord1.x < 0.9999 && fragCoord1.x > 0.0001 && fragCoord1.y < 1.9999 && fragCoord1.y > 0.4001 )
{
    _c0005 = TEX0.xy + vec2( location_x, separation + location_y);
    _TMP0 = COMPAT_TEXTURE(Texture, _c0005);
}
if ( fragCoord2.x < 0.9999 && fragCoord2.x > 0.0001 && fragCoord2.y < 1.9999 && fragCoord2.y > 0.4001 )
{
